        ...
        if (editId) {
          try {
            const response = await axios.get(
              `https://quizzie-ojx9.onrender.com/api/quiz/getaquiz/${editId}`
            );
  ...
  const handleCreateQuiz = async () => {
    ...
    try {
      const response = await axios.post(
        "https://quizzie-ojx9.onrender.com/api/quiz/createquiz",
        quizData,
        {
          headers: {
  ...
  const handleEditquiz = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://quizzie-ojx9.onrender.com/api/quiz/editquiz/${editId}`,
        quizData,
        {
          headers: {
            "Content-Type": "application/json",
